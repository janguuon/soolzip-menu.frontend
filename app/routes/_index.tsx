...
// 임시 칵테일 데이터
const cocktails = {
  "1": { name: "모히토", image: "/모히또.png" },
  "2": { name: "마르가리타", image: "/마르가리따.png" },
  "3": { name: "블루 하와이안", image: "/블루하와이안.png" }
};
      ...
      <div className="container mx-auto p-4 min-h-screen">
        ...
        <div className="max-w-xl mx-auto grid grid-cols-2 gap-8">
          {Object.entries(cocktails).map(([id, cocktail]) => (
            ...
            >
              <div className="w-full max-w-[200px] border rounded-lg p-4 flex items-center justify-center bg-[#E6D5B8] overflow-hidden">
                {cocktail.image ? (
                  <img
                    src={cocktail.image}
                    alt={cocktail.name}
